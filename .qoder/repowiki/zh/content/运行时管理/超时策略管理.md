...
## 项目结构
围绕超时策略的核心代码集中在以下模块：
- 策略定义与计算：rdx/timeout_policy.py
- CLI 调用链集成：rdx/cli.py
- Daemon 执行侧集成：rdx/daemon/server.py
- 运行时与远程连接集成：rdx/server_runtime.py
- 配置模型与环境变量：rdx/config.py
- 用户配置说明：docs/configuration.md
- 行为验证测试：tests/test_timeout_policy.py

```mermaid
graph TB
A["CLI<br/>rdx/cli.py"] --> B["Daemon Server<br/>rdx/daemon/server.py"]
B --> C["Runtime<br/>rdx/server_runtime.py"]
A --> D["Timeout Policy<br/>rdx/timeout_policy.py"]
B --> D
C --> D
E["Config<br/>rdx/config.py"] --> C
F["Docs<br/>docs/configuration.md"] --> E
```

图表来源
- [rdx/cli.py:46-46](file://rdx/cli.py#L46-L46)
- [rdx/daemon/server.py:29-29](file://rdx/daemon/server.py#L29-L29)
- [rdx/server_runtime.py:65-65](file://rdx/server_runtime.py#L65-L65)
...
- [rdx/cli.py:1-200](file://rdx/cli.py#L1-L200)
- [rdx/daemon/server.py:1-200](file://rdx/daemon/server.py#L1-L200)
- [rdx/server_runtime.py:60-259](file://rdx/server_runtime.py#L60-L259)
...
章节来源
- [rdx/timeout_policy.py:8-104](file://rdx/timeout_policy.py#L8-L104)
- [rdx/cli.py:46-46](file://rdx/cli.py#L46-L46)
- [rdx/daemon/server.py:29-29](file://rdx/daemon/server.py#L29-L29)
- [rdx/server_runtime.py:65-65](file://rdx/server_runtime.py#L65-L65)
- [rdx/config.py:118-186](file://rdx/config.py#L118-L186)
...
participant POL as "策略计算<br/>rdx/timeout_policy.py"
participant DAEMON as "Daemon Server<br/>rdx/daemon/server.py"
participant RUNTIME as "Runtime<br/>rdx/server_runtime.py"
...
图表来源
- [rdx/timeout_policy.py:56-84](file://rdx/timeout_policy.py#L56-L84)
...
participant U as "用户"
participant CLI as "CLI<br/>rdx/cli.py"
participant POL as "策略<br/>rdx/timeout_policy.py"
...
图表来源
- [rdx/cli.py:46-46](file://rdx/cli.py#L46-L46)
- [rdx/timeout_policy.py:94-99](file://rdx/timeout_policy.py#L94-L99)
...
章节来源
- [rdx/daemon/server.py:29-29](file://rdx/daemon/server.py#L29-L29)
- [rdx/timeout_policy.py:98-99](file://rdx/timeout_policy.py#L98-L99)
...
章节来源
- [rdx/server_runtime.py:65-65](file://rdx/server_runtime.py#L65-L65)
- [rdx/timeout_policy.py:8-16](file://rdx/timeout_policy.py#L8-L16)
...
- [docs/rdx-native-agent-playbook.md:34-47](file://docs/rdx-native-agent-playbook.md#L34-L47)
...
章节来源
- [rdx/timeout_policy.py:21-40](file://rdx/timeout_policy.py#L21-L40)
- [rdx/config.py:118-186](file://rdx/config.py#L118-L186)
