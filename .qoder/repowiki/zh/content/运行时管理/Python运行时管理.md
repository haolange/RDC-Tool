...
图表来源
- [rdc_tool/runtime_paths.py:14-123](file://rdc_tool/runtime_paths.py#L14-L123)
- [rdc_tool/runtime_bootstrap.py:42-130](file://rdc_tool/runtime_bootstrap.py#L42-L130)
- [rdc_tool/server_runtime.py:98-239](file://rdc_tool/server_runtime.py#L98-L239)
- [rdc_tool/runtime_worker.py:65-167](file://rdc_tool/runtime_worker.py#L65-L167)
- [rdc_tool/remote_bootstrap.py:495-698](file://rdc_tool/remote_bootstrap.py#L495-L698)
- [rdc_tool/python_runtime.py:64-172](file://rdc_tool/python_runtime.py#L64-L172)
- [rdc_tool/config.py:118-186](file://rdc_tool/config.py#L118-L186)
- [rdc_tool/io_utils.py:35-161](file://rdc_tool/io_utils.py#L35-L161)
...
章节来源
- [rdc_tool/runtime_paths.py:14-123](file://rdc_tool/runtime_paths.py#L14-L123)
- [rdc_tool/python_runtime.py:28-172](file://rdc_tool/python_runtime.py#L28-L172)
- [rdc_tool/runtime_bootstrap.py:42-130](file://rdc_tool/runtime_bootstrap.py#L42-L130)
- [rdc_tool/runtime_worker.py:65-167](file://rdc_tool/runtime_worker.py#L65-L167)
- [rdc_tool/server_runtime.py:98-239](file://rdc_tool/server_runtime.py#L98-L239)
- [rdc_tool/remote_bootstrap.py:495-698](file://rdc_tool/remote_bootstrap.py#L495-L698)
...
- [rdc_tool/server_runtime.py:98-239](file://rdc_tool/server_runtime.py#L98-L239)
- [rdc_tool/remote_bootstrap.py:495-698](file://rdc_tool/remote_bootstrap.py#L495-L698)
- [rdc_tool/runtime_state.py:41-116](file://rdc_tool/runtime_state.py#L41-L116)

## 详细组件分析

### Python环境发现与选择策略
- 工具根与二进制根：优先使用RDC_TOOL_ROOT环境变量，否则回退到当前包根；二进制根固定为tools_root/binaries/windows/x64。
...
```mermaid
flowchart TD
Start(["开始"]) --> CheckEnv{"是否设置RDC_TOOL_ROOT?"}
...
- [rdc_tool/python_runtime.py:40-92](file://rdc_tool/python_runtime.py#L40-L92)
- [rdc_tool/python_runtime.py:104-172](file://rdc_tool/python_runtime.py#L104-L172)

章节来源
- [rdc_tool/runtime_paths.py:14-80](file://rdc_tool/runtime_paths.py#L14-L80)
- [rdc_tool/python_runtime.py:40-172](file://rdc_tool/python_runtime.py#L40-L172)
...
图表来源
- [rdc_tool/runtime_bootstrap.py:60-103](file://rdc_tool/runtime_bootstrap.py#L60-L103)

章节来源
- [rdc_tool/runtime_bootstrap.py:60-103](file://rdc_tool/runtime_bootstrap.py#L60-L103)

### 运行时隔离技术（会话级上下文）
- 上下文标识：通过RDC_TOOL_CONTEXT_ID或contextvars维护当前上下文ID，所有状态按上下文隔离。
- 上下文容量限制：根据配置限制最大上下文数、每上下文会话数、捕获文件数量等，超出时抛出明确错误。
- 上下文状态持久化：每个上下文的状态保存在intermediate/runtime/rdc_cli下的JSON文件中，带锁保护并发写。
...
图表来源
- [rdc_tool/server_runtime.py:196-239](file://rdc_tool/server_runtime.py#L196-L239)
...
章节来源
- [rdc_tool/runtime_worker.py:25-63](file://rdc_tool/runtime_worker.py#L25-L63)
- [rdc_tool/runtime_worker.py:65-167](file://rdc_tool/runtime_worker.py#L65-L167)
...
图表来源
- [rdc_tool/remote_bootstrap.py:133-167](file://rdc_tool/remote_bootstrap.py#L133-L167)
- [rdc_tool/remote_bootstrap.py:495-698](file://rdc_tool/remote_bootstrap.py#L495-L698)
- [rdc_tool/remote_bootstrap.py:701-754](file://rdc_tool/remote_bootstrap.py#L701-L754)
...
章节来源
- [rdc_tool/runtime_state.py:63-76](file://rdc_tool/runtime_state.py#L63-L76)
- [rdc_tool/io_utils.py:67-161](file://rdc_tool/io_utils.py#L67-L161)
- [rdc_tool/remote_bootstrap.py:701-754](file://rdc_tool/remote_bootstrap.py#L701-L754)
- [rdc_tool/config.py:82-90](file://rdc_tool/config.py#L82-L90)

### 配置选项与性能调优建议
- 关键环境变量：
  - RDC_TOOL_ROOT：覆盖工具根目录
  - RDC_TOOL_RUNTIME_DLL_DIR / RDC_TOOL_RENDERDOC_PATH：覆盖二进制与pymodules路径
  - RDC_TOOL_ARTIFACT_STORE / RDC_TOOL_DATA_DIR / RDC_TOOL_REPORT_DIR：覆盖工件、数据库、报告输出路径
  - RDC_TOOL_LOG_LEVEL / RDC_TOOL_GPU_VENDOR / RDC_TOOL_HEADLESS：调整日志级别、GPU供应商、无头模式
  - RDC_TOOL_BISECT_* / RDC_TOOL_MAX_*：调整二分搜索权重与运行时限制
- 运行时限制：
...
章节来源
- [rdc_tool/config.py:118-186](file://rdc_tool/config.py#L118-L186)
- [rdc_tool/server_runtime.py:277-390](file://rdc_tool/server_runtime.py#L277-L390)
...
图表来源
- [rdc_tool/runtime_paths.py:14-123](file://rdc_tool/runtime_paths.py#L14-L123)
- [rdc_tool/python_runtime.py:11-172](file://rdc_tool/python_runtime.py#L11-L172)
- [rdc_tool/runtime_bootstrap.py:12-130](file://rdc_tool/runtime_bootstrap.py#L12-L130)
- [rdc_tool/runtime_worker.py:15-167](file://rdc_tool/runtime_worker.py#L15-L167)
- [rdc_tool/server_runtime.py:37-96](file://rdc_tool/server_runtime.py#L37-L96)
- [rdc_tool/remote_bootstrap.py:17-785](file://rdc_tool/remote_bootstrap.py#L17-L785)
- [rdc_tool/io_utils.py:1-161](file://rdc_tool/io_utils.py#L1-L161)
...
章节来源
- [rdc_tool/python_runtime.py:104-172](file://rdc_tool/python_runtime.py#L104-L172)
- [rdc_tool/runtime_bootstrap.py:93-103](file://rdc_tool/runtime_bootstrap.py#L93-L103)
- [rdc_tool/runtime_worker.py:72-89](file://rdc_tool/runtime_worker.py#L72-L89)
- [rdc_tool/remote_bootstrap.py:701-754](file://rdc_tool/remote_bootstrap.py#L701-L754)
- [rdc_tool/runtime_state.py:419-425](file://rdc_tool/runtime_state.py#L419-L425)
...
## 附录
- 关键环境变量速查：
  - RDC_TOOL_ROOT、RDC_TOOL_RUNTIME_DLL_DIR、RDC_TOOL_RENDERDOC_PATH
  - RDC_TOOL_ARTIFACT_STORE、RDC_TOOL_DATA_DIR、RDC_TOOL_REPORT_DIR
  - RDC_TOOL_LOG_LEVEL、RDC_TOOL_GPU_VENDOR、RDC_TOOL_HEADLESS
  - RDC_TOOL_BISECT_*、RDC_TOOL_MAX_*
- 常用路径：
...
- [rdc_tool/runtime_paths.py:60-123](file://rdc_tool/runtime_paths.py#L60-L123)