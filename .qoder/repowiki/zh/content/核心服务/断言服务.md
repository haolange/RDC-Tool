...
```mermaid
graph TB
CLI["命令行接口<br/>rdc cli"] --> AssertService["断言服务<br/>AssertService"]
...
- [verifiers.py:68-852](file://rdc_tool/core/verifiers.py#L68-L852)
- [pipeline_service.py:590-702](file://rdc_tool/core/pipeline_service.py#L590-L702)
- [image_utils.py:80-220](file://rdc_tool/utils/image_utils.py#L80-L220)
...
- [image_utils.py:80-220](file://rdc_tool/utils/image_utils.py#L80-L220)
- [diff_service.py:11-51](file://rdc_tool/core/diff_service.py#L11-L51)
- [experiment_runner.py:144-222](file://rdc_tool/core/experiment_runner.py#L144-L222)
...
章节来源
- [experiment_runner.py:144-222](file://rdc_tool/core/experiment_runner.py#L144-L222)
- [experiment_runner.py:332-372](file://rdc_tool/core/experiment_runner.py#L332-L372)
- [experiment_runner.py:451-537](file://rdc_tool/core/experiment_runner.py#L451-L537)
...
章节来源
- [verifiers.py:101-172](file://rdc_tool/core/verifiers.py#L101-L172)
- [verifiers.py:268-347](file://rdc_tool/core/verifiers.py#L268-L347)
- [verifiers.py:432-584](file://rdc_tool/core/verifiers.py#L432-L584)
- [pipeline_service.py:590-702](file://rdc_tool/core/pipeline_service.py#L590-L702)
...
### 使用示例
- 管线差异断言
  - 通过CLI调用rdc-tool pipeline diff，传入session_id、event_a、event_b与max_changes阈值。
  - 断言服务解析payload中的diff数量并与阈值比较，输出标准化JSON与退出码。
- 图像指标断言
  - 通过CLI调用rdc image diff，传入image_a、image_b与mse_max、max_abs_max、psnr_min阈值。
