...
## 项目结构
性能分析服务位于 rdc 子系统中，核心实现集中在 core 层，并通过 server_runtime 暴露为可被上层调用的动作接口；handlers 提供轻量转发入口；models 定义统一的数据模型。
...
- [server_runtime.py:11040-11115](file://rdc_tool/server_runtime.py#L11040-L11115)
...
- [perf_service.py:493-617](file://rdc_tool/core/perf_service.py#L493-L617)
- [models.py:463-482](file://rdc_tool/models.py#L463-L482)
...
章节来源
- [perf_service.py:212-229](file://rdc_tool/core/perf_service.py#L212-L229)
- [perf_service.py:28-63](file://rdc_tool/core/perf_service.py#L28-L63)
- [models.py:463-482](file://rdc_tool/models.py#L463-L482)
...
图表来源
- [perf_service.py:493-617](file://rdc_tool/core/perf_service.py#L493-L617)
- [server_runtime.py:11100-11114](file://rdc_tool/server_runtime.py#L11100-L11114)
...
- renderdoc 模块不可用：
  ...
  - 处理：确保渲染文档 Python 模块在 sys.path 中或设置 RDC_TOOL_RENDERDOC_PATH。
- 控制器获取失败：
...
章节来源
- [perf_service.py:264-308](file://rdc_tool/core/perf_service.py#L264-L308)
- [perf_service.py:342-380](file://rdc_tool/core/perf_service.py#L342-L380)
- [perf_service.py:526-576](file://rdc_tool/core/perf_service.py#L526-L576)
