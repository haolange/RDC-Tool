...
```mermaid
graph TB
A["CLI 命令<br/>rdx diff/ assert"] --> B["DiffService<br/>diff_pipeline / diff_image"]
...
图表来源
- [diff_service.py:11-50](file://rdx/core/diff_service.py#L11-L50)
...
- [assert_service.py:16-79](file://rdx/core/assert_service.py#L16-L79)
...
章节来源
- [diff_service.py:11-50](file://rdx/core/diff_service.py#L11-L50)
- [pipeline_service.py:87-186](file://rdx/core/pipeline_service.py#L87-L186)
- [pipeline_service.py:193-373](file://rdx/core/pipeline_service.py#L193-L373)
- [pipeline_service.py:392-502](file://rdx/core/pipeline_service.py#L392-L502)
- [pipeline_service.py:597-702](file://rdx/core/pipeline_service.py#L597-L702)
- [image_utils.py:80-135](file://rdx/utils/image_utils.py#L80-L135)
- [image_utils.py:143-220](file://rdx/utils/image_utils.py#L143-L220)
- [image_utils.py:311-367](file://rdx/utils/image_utils.py#L311-L367)
- [image_utils.py:375-426](file://rdx/utils/image_utils.py#L375-L426)
- [image_utils.py:434-477](file://rdx/utils/image_utils.py#L434-L477)
- [assert_service.py:16-79](file://rdx/core/assert_service.py#L16-L79)
- [report_builder.py:472-560](file://rdx/core/report_builder.py#L472-L560)
- [models.py:28-91](file://rdx/models.py#L28-L91)
...
章节来源
- [pipeline_service.py:35-48](file://rdx/core/pipeline_service.py#L35-L48)
- [pipeline_service.py:193-295](file://rdx/core/pipeline_service.py#L193-L295)
- [image_utils.py:143-183](file://rdx/utils/image_utils.py#L143-L183)
- [assert_service.py:16-79](file://rdx/core/assert_service.py#L16-L79)
- [server.py:90-120](file://rdx/server.py#L90-L120)
...
- 管线差异
  ...
  - 参考路径：[diff_service.py:11-29](file://rdx/core/diff_service.py#L11-L29)
- 图像差异
  ...
  - 参考路径：[diff_service.py:31-50](file://rdx/core/diff_service.py#L31-L50)
...
- 管线断言
  ...
  - 参考路径：[assert_service.py:16-35](file://rdx/core/assert_service.py#L16-L35)
- 图像断言
  ...
  - 参考路径：[assert_service.py:37-79](file://rdx/core/assert_service.py#L37-L79)
...
### CLI 命令示例
- 管线差异
  - 命令：rdx diff pipeline --session-id <id> --event-a <a> --event-b <b> [--fail-on-diff]
  - 行为：执行管线差异，可选择存在差异即失败
  - 参考路径：[cli.py:1583-1585](file://rdx/cli.py#L1583-L1585)
- 图像差异
  - 命令：rdx diff image --image-a <path> --image-b <path> [--out <path>] [--threshold <float>]
  - 行为：执行图像差异，可选输出差异图与阈值
  - 参考路径：[cli.py:1586-1590](file://rdx/cli.py#L1586-L1590)
- 断言
  - 管线断言：rdx assert pipeline --session-id <id> --event-a <a> --event-b <b> [--max-changes <int>]
  - 图像断言：rdx assert image --image-a <path> --image-b <path> [--out <path>] [--mse-max <float>] [--max-abs-max <float>] [--psnr-min <float>]
  - 参考路径：[cli.py:1592-1604](file://rdx/cli.py#L1592-L1604)、[cli.py:1332-1378](file://rdx/cli.py#L1332-L1378)

章节来源
- [cli.py:1332-1378](file://rdx/cli.py#L1332-L1378)
- [cli.py:1583-1604](file://rdx/cli.py#L1583-L1604)

### 实际使用场景
- 回归测试
  - 在 CI 中执行 rdx diff pipeline/ image，设置严格阈值（如 max_changes=0、mse_max=0），失败即阻断。
- 性能基准比较
  - 对不同版本的构建执行 rdx diff pipeline 与 rdx assert image，关注 metrics 变化（如 GPU duration、anomaly_score）。
- 问题复现验证
  - 针对已知问题，构造最小用例，执行 rdx diff pipeline/ image，生成 report bundle 便于回溯。
