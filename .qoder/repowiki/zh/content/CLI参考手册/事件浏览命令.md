...
- [rdc_tool/core/tsv_projection.py](file://rdc_tool/core/tsv_projection.py)
...
- rdc-tool event list：列出当前帧的 GPU 调用事件（Action 树），支持 --format tsv 输出表格。
- rdc-tool event show：查看指定事件的详细信息，通过 --event-id 指定事件 ID。
...
```mermaid
graph TB
CLI["CLI: rdc-tool event list/show"] --> Facade["_facade_request<br/>映射到 rd.event.*"]
...
- [rdc_tool/core/tsv_projection.py:17-51](file://rdc_tool/core/tsv_projection.py#L17-L51)
...
## 核心组件
- CLI 门面：将 rdc-tool event list/show 转换为 rd.event.get_action_tree / rd.event.get_action_details 调用，并处理 --session-id、--event-id、--format。
...
章节来源
- [rdc_tool/cli.py:1392-1506](file://rdc_tool/cli.py#L1392-L1506)
- [rdc_tool/core/event_graph.py:152-386](file://rdc_tool/core/event_graph.py#L152-L386)
- [rdc_tool/models.py:163-301](file://rdc_tool/models.py#L163-L301)
- [rdc_tool/core/tsv_projection.py:17-51](file://rdc_tool/core/tsv_projection.py#L17-L51)
...
sequenceDiagram
participant U as "用户"
participant C as "CLI (rdc cli.py)"
...
U->>C : rdc-tool event list [--format tsv]
C->>F : 解析参数/会话ID
...
C-->>U : 表格或 JSON
U->>C : rdc-tool event show --event-id N
...
章节来源
- [docs/tool-reference.md:104-116](file://docs/tool-reference.md#L104-L116)
- [rdc_tool/models.py:42-51](file://rdc_tool/models.py#L42-L51)
- [rdc_tool/models.py:163-171](file://rdc_tool/models.py#L163-L171)
...
- [rdc_tool/core/event_graph.py:107-146](file://rdc_tool/core/event_graph.py#L107-L146)
- [docs/tool-reference.md:104-116](file://docs/tool-reference.md#L104-L116)
...
- 查看特定事件详情：
  - rdc-tool event show --event-id <N>
