...
## 简介
本文件面向“管线状态”相关命令，系统性说明如何使用 rdx pipeline show 与 rdx pipeline section 获取并分析 GPU 管线的当前状态。内容覆盖顶点输入、光栅化、片段着色等阶段的配置；着色器绑定、常量缓冲区、纹理采样器等查询选项；以及如何在实际调试中定位渲染问题、对比不同帧的管线状态差异。同时解释管线状态的数据结构与对应 GPU 硬件概念的关系，帮助读者从命令行到内部服务再到 RenderDoc API 的全链路理解。
...
```mermaid
graph TB
A["CLI: rdx pipeline show/section"] --> B["Handler: pipeline.handle"]
...
图表来源
- [rdx/cli.py:1508-1518](file://rdx/cli.py#L1508-L1518)
- [rdx/handlers/pipeline.py:8-10](file://rdx/handlers/pipeline.py#L8-L10)
- [rdx/server_runtime.py:7470-7500](file://rdx/server_runtime.py#L7470-L7500)
- [rdx/core/pipeline_service.py:590-702](file://rdx/core/pipeline_service.py#L590-L702)
- [rdx/models.py:280-300](file://rdx/models.py#L280-L300)
...
章节来源
- [rdx/cli.py:1389-1518](file://rdx/cli.py#L1389-L1518)
- [rdx/handlers/pipeline.py:8-10](file://rdx/handlers/pipeline.py#L8-L10)
- [rdx/server_runtime.py:7470-7500](file://rdx/server_runtime.py#L7470-L7500)
- [rdx/core/pipeline_service.py:590-702](file://rdx/core/pipeline_service.py#L590-L702)
- [rdx/models.py:224-300](file://rdx/models.py#L224-L300)
...
U->>CLI : rdx pipeline show --session-id X --event-id Y [--format]
CLI->>H : 解析参数并构造调用
...
图表来源
- [rdx/server_runtime.py:7504-7549](file://rdx/server_runtime.py#L7504-L7549)
- [rdx/core/pipeline_service.py:392-502](file://rdx/core/pipeline_service.py#L392-L502)
...
章节来源
- [rdx/models.py:224-300](file://rdx/models.py#L224-L300)
- [rdx/core/pipeline_service.py:193-327](file://rdx/core/pipeline_service.py#L193-L327)
...
章节来源
- [rdx/core/pipeline_service.py:318-373](file://rdx/core/pipeline_service.py#L318-L373)
- [rdx/server_runtime.py:7470-7500](file://rdx/server_runtime.py#L7470-L7500)
...
章节来源
- [rdx/server_runtime.py:7470-7500](file://rdx/server_runtime.py#L7470-L7500)
- [rdx/server_runtime.py:7504-7621](file://rdx/server_runtime.py#L7504-L7621)

## 结论
rdx pipeline show 与 rdx pipeline section 提供了从高层摘要到阶段细节的完整管线状态查询能力。通过 sections 精细控制、结合模型化的数据结构与 RenderDoc 底层 API，用户可以高效地分析顶点输入、光栅化、片段着色等阶段配置，定位渲染问题，并在不同帧之间对比差异。建议在复杂场景中优先使用 sections 过滤与 stage 限定，以获得更聚焦且高效的诊断结果。
...
- 基本用法
  - 获取某事件的管线摘要：rdx pipeline show --session-id <id> --event-id <id> --format json
  - 获取完整管线快照：rdx pipeline show --session-id <id> --event-id <id> --format json
  - 查看片段阶段状态：rdx pipeline section --session-id <id> --event-id <id> --stage ps --format json

- 聚焦特定 sections
  - 仅查看绑定：rdx pipeline show --session-id <id> --event-id <id> --format json --sections bindings
  - 仅查看渲染目标：rdx pipeline show --session-id <id> --event-id <id> --format json --sections output_targets
