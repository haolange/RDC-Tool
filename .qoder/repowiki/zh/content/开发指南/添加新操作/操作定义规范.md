...
## 项目结构
- 操作元数据集中定义在 rdx/operation_definitions.py 的 OPERATIONS 数组中，每个元素描述一个 rd.* 操作。
...
```mermaid
graph TB
A["rdx/operation_definitions.py<br/>OPERATIONS 数组"] --> B["docs/tool-reference.md<br/>自动生成文档"]
A --> C["rdx/server.py<br/>请求路由/执行/记录"]
C --> D["rdx/core/operation_registry.py<br/>操作名→处理器映射"]
```

图示来源
- [operation_definitions.py:1-100](file://rdx/operation_definitions.py#L1-L100)
- [tool-reference.md:1-12](file://docs/tool-reference.md#L1-L12)
- [server.py:118-149](file://rdx/server.py#L118-L149)
...
participant Server as "rdx/server.py"
...
章节来源
- [operation_definitions.py:1-100](file://rdx/operation_definitions.py#L1-L100)
- [operation_definitions.py:1166-1284](file://rdx/operation_definitions.py#L1166-L1284)
- [operation_definitions.py:1390-1460](file://rdx/operation_definitions.py#L1390-L1460)
- [operation_definitions.py:1960-2007](file://rdx/operation_definitions.py#L1960-L2007)
- [operation_definitions.py:2286-2371](file://rdx/operation_definitions.py#L2286-L2371)
...
章节来源
- [operation_definitions.py:32-66](file://rdx/operation_definitions.py#L32-L66)
- [operation_definitions.py:83-124](file://rdx/operation_definitions.py#L83-L124)
- [operation_definitions.py:140-160](file://rdx/operation_definitions.py#L140-L160)
- [operation_definitions.py:233-244](file://rdx/operation_definitions.py#L233-L244)
- [operation_definitions.py:269-282](file://rdx/operation_definitions.py#L269-L282)
...
章节来源
- [operation_definitions.py:28-31](file://rdx/operation_definitions.py#L28-L31)
- [operation_definitions.py:189-191](file://rdx/operation_definitions.py#L189-L191)
- [operation_definitions.py:260-267](file://rdx/operation_definitions.py#L260-L267)
- [operation_definitions.py:1982-1985](file://rdx/operation_definitions.py#L1982-L1985)
...
章节来源
- [operation_definitions.py:63-66](file://rdx/operation_definitions.py#L63-L66)
- [operation_definitions.py:178-181](file://rdx/operation_definitions.py#L178-L181)
- [operation_definitions.py:241-244](file://rdx/operation_definitions.py#L241-L244)
- [operation_definitions.py:279-282](file://rdx/operation_definitions.py#L279-L282)
- [operation_definitions.py:303-306](file://rdx/operation_definitions.py#L303-L306)
- [operation_definitions.py:557-560](file://rdx/operation_definitions.py#L557-L560)
- [operation_definitions.py:593-596](file://rdx/operation_definitions.py#L593-L596)
- [operation_definitions.py:616-618](file://rdx/operation_definitions.py#L616-L618)
- [operation_definitions.py:1193-1196](file://rdx/operation_definitions.py#L1193-L1196)
- [operation_definitions.py:1243-1246](file://rdx/operation_definitions.py#L1243-L1246)
- [operation_definitions.py:1280-1283](file://rdx/operation_definitions.py#L1280-L1283)
- [operation_definitions.py:1339-1342](file://rdx/operation_definitions.py#L1339-L1342)
- [operation_definitions.py:1386-1389](file://rdx/operation_definitions.py#L1386-L1389)
- [operation_definitions.py:1457-1460](file://rdx/operation_definitions.py#L1457-L1460)
- [operation_definitions.py:2004-2007](file://rdx/operation_definitions.py#L2004-L2007)
- [operation_definitions.py:2302-2305](file://rdx/operation_definitions.py#L2302-L2305)
- [operation_definitions.py:2368-2371](file://rdx/operation_definitions.py#L2368-L2371)
...
- 缓冲区读取（重放作用域，临时位置变更，可能写工件）
  - 参考：[operation_definitions.py:4-66](file://rdx/operation_definitions.py#L4-L66)
- 结构化缓冲解码（重放作用域，位置变更）
  - 参考：[operation_definitions.py:67-124](file://rdx/operation_definitions.py#L67-L124)
- 捕获文件打开（全局作用域，生命周期变更，读路径）
  - 参考：[operation_definitions.py:223-244](file://rdx/operation_definitions.py#L223-L244)
- 创建回放会话（全局作用域，生命周期变更，条件前置）
  - 参考：[operation_definitions.py:245-282](file://rdx/operation_definitions.py#L245-L282)
- 导出截图（重放作用域，位置变更，写工件，证据类型为 measurement）
  - 参考：[operation_definitions.py:1284-1342](file://rdx/operation_definitions.py#L1284-L1342)
- 导出纹理（重放作用域，位置变更，写工件，证据类型为 measurement）
  - 参考：[operation_definitions.py:1390-1460](file://rdx/operation_definitions.py#L1390-L1460)
- 远程连接（全局作用域，远程控制，能力前置）
  - 参考：[operation_definitions.py:1960-2007](file://rdx/operation_definitions.py#L1960-L2007)
- 切换帧（重放作用域，位置变更）
  - 参考：[operation_definitions.py:2349-2371](file://rdx/operation_definitions.py#L2349-L2371)

章节来源
- [operation_definitions.py:4-66](file://rdx/operation_definitions.py#L4-L66)
- [operation_definitions.py:67-124](file://rdx/operation_definitions.py#L67-L124)
- [operation_definitions.py:223-244](file://rdx/operation_definitions.py#L223-L244)
- [operation_definitions.py:245-282](file://rdx/operation_definitions.py#L245-L282)
- [operation_definitions.py:1284-1342](file://rdx/operation_definitions.py#L1284-L1342)
- [operation_definitions.py:1390-1460](file://rdx/operation_definitions.py#L1390-L1460)
- [operation_definitions.py:1960-2007](file://rdx/operation_definitions.py#L1960-L2007)
- [operation_definitions.py:2349-2371](file://rdx/operation_definitions.py#L2349-L2371)
...
章节来源
- [operation_definitions.py:4-66](file://rdx/operation_definitions.py#L4-L66)
- [operation_definitions.py:1648-1678](file://rdx/operation_definitions.py#L1648-L1678)
- [operation_definitions.py:1679-1714](file://rdx/operation_definitions.py#L1679-L1714)
- [operation_definitions.py:233-244](file://rdx/operation_definitions.py#L233-L244)
