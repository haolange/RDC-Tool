...
```mermaid
graph TB
A["操作定义<br/>rdc_tool/operation_definitions.py"] --> B["目录构建<br/>rdc_tool/runtime_catalog.py"]
B --> C["目录产物<br/>spec/tool_catalog.json"]
C --> D["路由注册与校验<br/>rdc_tool/tool_router.py"]
D --> E["统一执行引擎<br/>rdc_tool/core/engine.py"]
E --> F["领域处理器<br/>handlers/*"]
E --> G["契约封装<br/>rdc_tool/core/contracts.py"]
E --> H["错误分类<br/>rdc_tool/core/errors.py"]
```

图表来源
- [rdc_tool/operation_definitions.py:1-20](file://rdc_tool/operation_definitions.py#L1-L20)
- [rdc_tool/runtime_catalog.py:13-28](file://rdc_tool/runtime_catalog.py#L13-L28)
- [spec/tool_catalog.json:1-25](file://spec/tool_catalog.json#L1-L25)
- [rdc_tool/tool_router.py:56-156](file://rdc_tool/tool_router.py#L56-L156)
...
- CLI 与版本信息：CLI 暴露 rdc-tool version --json 等能力，输出 schema_version、平台、入口点与兼容性元数据。

章节来源
- [rdc_tool/operation_definitions.py:1-800](file://rdc_tool/operation_definitions.py#L1-L800)
- [rdc_tool/runtime_catalog.py:17-91](file://rdc_tool/runtime_catalog.py#L17-L91)
- [rdc_tool/tool_router.py:60-156](file://rdc_tool/tool_router.py#L60-L156)
- [rdc_tool/core/engine.py:30-200](file://rdc_tool/core/engine.py#L30-L200)
- [rdc_tool/core/contracts.py:14-164](file://rdc_tool/core/contracts.py#L14-L164)
- [rdc_tool/core/errors.py:9-121](file://rdc_tool/core/errors.py#L9-L121)
- [rdc_tool/cli.py:535-550](file://rdc_tool/cli.py#L535-L550)
...
图表来源
- [rdc_tool/tool_router.py:80-156](file://rdc_tool/tool_router.py#L80-L156)
...
- CLI 版本输出：rdc-tool version --json 输出 tool_version、schema_version、platform、entrypoints、compatibility 等元数据。
...
章节来源
- [rdc_tool/core/contracts.py:14-24](file://rdc_tool/core/contracts.py#L14-L24)
- [rdc_tool/cli.py:535-550](file://rdc_tool/cli.py#L535-L550)
...
- 版本不一致：通过 rdc-tool version --json 检查 schema_version 与 tool_version，结合 catalog fingerprint 判断目录是否变化。

章节来源
- [rdc_tool/tool_router.py:64-128](file://rdc_tool/tool_router.py#L64-L128)
- [rdc_tool/core/engine.py:62-75](file://rdc_tool/core/engine.py#L62-L75)
- [rdc_tool/core/errors.py:90-121](file://rdc_tool/core/errors.py#L90-L121)
- [rdc_tool/cli.py:535-550](file://rdc_tool/cli.py#L535-L550)
...
### 操作定义的版本管理
- 版本检测：通过 rdc-tool version --json 获取 schema_version 与 tool_version；catalog fingerprint 用于检测目录变化。
...
- [rdc_tool/cli.py:509-532](file://rdc_tool/cli.py#L509-L532)
...
### 客户端适配策略
- 自动检测：使用 rdc-tool version --json 与 catalog fingerprint 检测版本与目录变化；根据 capabilities 与 tool graph 选择合适操作。
...
- 特性检测：使用 rdc_tool.core.get_capabilities 与 rdc_tool.core.list_tools 探测可用能力与工具。
