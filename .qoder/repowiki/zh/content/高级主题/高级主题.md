...
- [rdc_tool/runtimeworker.py](file://rdc_tool/runtime_worker.py)
- [rdc_tool/daemon/server.py](file://rdc_tool/daemon/server.py)
- [rdc_tool/core/artifact_publisher.py](file://rdc_tool/core/artifact_publisher.py)
...
## 简介
本章节面向高级用户与专家，聚焦 RDC-Tool 在高性能回放、远程 Android 回放、会话上下文管理、操作路由、工件发布、GPU 性能采样、守护进程与工作者进程协作等方面的设计与实现。文档围绕以下目标展开：
- 深入说明内存管理与 I/O 优化策略
- 解释并发处理机制与隔离模型
...
## 项目结构
RDC-Tool 采用“CLI + 守护进程 + 工作者进程”的三层架构：
...
```mermaid
graph TB
CLI["命令行 rdc"] --> Server["运行时调度 server.dispatch_operation"]
...
- [rdc_tool/daemon/server.py:452-492](file://rdc_tool/daemon/server.py#L452-L492)
- [rdc_tool/runtimeworker.py:91-161](file://rdc_tool/runtimeworker.py#L91-L161)
- [rdc_tool/core/artifact_publisher.py:60-118](file://rdc_tool/core/artifact_publisher.py#L60-L118)
...
- [rdc_tool/runtimeworker.py:65-161](file://rdc_tool/runtimeworker.py#L65-L161)
- [rdc_tool/core/perf_service.py:212-618](file://rdc_tool/core/perf_service.py#L212-L618)
- [rdc_tool/core/artifact_publisher.py:15-118](file://rdc_tool/core/artifact_publisher.py#L15-L118)
...
**图表来源**
- [rdc_tool/server.py:62-145](file://rdc_tool/server.py#L62-L145)
- [rdc_tool/core/engine.py:40-203](file://rdc_tool/core/engine.py#L40-L203)
- [rdc_tool/tool_router.py:131-154](file://rdc_tool/tool_router.py#L131-L154)
- [rdc_tool/core/artifact_publisher.py:60-118](file://rdc_tool/core/artifact_publisher.py#L60-L118)
...
**章节来源**
- [rdc_tool/core/engine.py:21-203](file://rdc_tool/core/engine.py#L21-L203)
...
**章节来源**
- [rdc_tool/daemon/server.py:102-728](file://rdc_tool/daemon/server.py#L102-L728)
- [rdc_tool/runtimeworker.py:1-167](file://rdc_tool/runtimeworker.py#L1-L167)
...
**章节来源**
- [rdc_tool/core/perf_service.py:1-618](file://rdc_tool/core/perf_service.py#L1-L618)
...
**章节来源**
- [rdc_tool/core/artifact_publisher.py:1-124](file://rdc_tool/core/artifact_publisher.py#L1-L124)
...
- [rdc_tool/tool_router.py:34-57](file://rdc_tool/tool_router.py#L34-L57)
- [rdc_tool/server.py:38-145](file://rdc_tool/server.py#L38-L145)
- [rdc_tool/daemon/server.py:358-374](file://rdc_tool/daemon/server.py#L358-L374)
- [rdc_tool/core/perf_service.py:69-96](file://rdc_tool/core/perf_service.py#L69-L96)

**章节来源**
- [rdc_tool/core/engine.py:1-204](file://rdc_tool/core/engine.py#L1-L204)
- [rdc_tool/tool_router.py:1-156](file://rdc_tool/tool_router.py#L1-L156)
...
**章节来源**
- [rdc_tool/core/perf_service.py:223-229](file://rdc_tool/core/perf_service.py#L223-L229)
- [rdc_tool/runtimeworker.py:91-95](file://rdc_tool/runtimeworker.py#L91-L95)
- [rdc_tool/core/perf_service.py:28-63](file://rdc_tool/core/perf_service.py#L28-L63)
- [rdc_tool/config.py:82-90](file://rdc_tool/config.py#L82-L90)
- [rdc_tool/core/artifact_publisher.py:17-33](file://rdc_tool/core/artifact_publisher.py#L17-L33)
- [rdc_tool/server.py:84-88](file://rdc_tool/server.py#L84-L88)
...
- [rdc_tool/daemon/server.py:415-439](file://rdc_tool/daemon/server.py#L415-L439)
- [rdc_tool/daemon/server.py:548-569](file://rdc_tool/daemon/server.py#L548-L569)
- [rdc_tool/core/artifact_publisher.py:35-58](file://rdc_tool/core/artifact_publisher.py#L35-L58)
...
- 自适应二分：模式与历史存储路径
- 环境变量覆盖：RDC_TOOL_RENDERDOC_PATH、RDC_TOOL_ARTIFACT_STORE、RDC_TOOL_DATA_DIR、RDC_TOOL_REPORT_DIR、RDC_TOOL_LOG_LEVEL、RDC_TOOL_GPU_VENDOR、RDC_TOOL_SPIRV_TOOLS_PATH、RDC_TOOL_HEADLESS、RDC_TOOL_BISECT_*、RDC_TOOL_CONTEXT_ARTIFACT_*、RDC_TOOL_MAX_*、RDC_TOOL_REPLAY_MEMORY_MULTIPLIER
...
- 可观测性：
  - 日志级别：RDC_TOOL_LOG_LEVEL
  - 中间产物：intermediate/runtime/logs/artifacts
  - Doctor 诊断：rdc-tool --json doctor 报告工具根、Python 运行时、RenderDoc 布局、catalog 数量、启动器与守护进程状态

**章节来源**
- [rdc_tool/core/perf_service.py:28-63](file://rdc_tool/core/perf_service.py#L28-L63)
- [rdc_tool/core/perf_service.py:493-618](file://rdc_tool/core/perf_service.py#L493-L618)
- [rdc_tool/core/engine.py:56-75](file://rdc_tool/core/engine.py#L56-L75)
- [rdc_tool/daemon/server.py:129-159](file://rdc_tool/daemon/server.py#L129-L159)
- [rdc_tool/daemon/server.py:287-298](file://rdc_tool/daemon/server.py#L287-L298)
...
## 故障排查与调试技巧
- Doctor 与环境：首先运行 rdc-tool --json doctor，确认工具根、Python、RenderDoc 布局、catalog 数量、启动器与守护进程状态
- 会话状态：rdc-tool context status 查看活跃上下文；必要时 clear 并重新打开 .rdc；使用 update 留下 agent 可见恢复备注
...
## 结论
RDC-Tool 通过核心引擎、工具路由、守护进程与工作者进程的协同，提供了稳定、可扩展、可观测的渲染回放与分析平台。其设计强调：
