...
- [perf.py:1-11](file://rdc_tool/handlers/perf.py#L1-L11)
...
- [perf_service.py:212-320](file://rdc_tool/core/perf_service.py#L212-L320)
- [renderdoc_status.py:10-105](file://rdc_tool/core/renderdoc_status.py#L10-L105)
- [remote_bootstrap.py:1-784](file://rdc_tool/remote_bootstrap.py#L1-L784)
...
- 配置（RdcToolConfig）：集中管理后端、重放、工件存储、数据库、二分搜索、补丁、报告、置信度权重、快照保留、运行时限制、日志级别等。
...
- [debug_service.py:43-120](file://rdc_tool/core/debug_service.py#L43-L120)
- [perf_service.py:212-320](file://rdc_tool/core/perf_service.py#L212-L320)
- [server_runtime.py:230-390](file://rdc_tool/server_runtime.py#L230-L390)
- [config.py:117-186](file://rdc_tool/config.py#L117-L186)
- [models.py:103-140](file://rdc_tool/models.py#L103-L140)
- [renderdoc_status.py:10-105](file://rdc_tool/core/renderdoc_status.py#L10-L105)
- [runtime_state.py:104-149](file://rdc_tool/runtime_state.py#L104-L149)
- [debug.py:1-11](file://rdc_tool/handlers/debug.py#L1-L11)
- [perf.py:1-11](file://rdc_tool/handlers/perf.py#L1-L11)
...
- [debug_service.py:573-614](file://rdc_tool/core/debug_service.py#L573-L614)
...
- [perf_service.py:28-64](file://rdc_tool/core/perf_service.py#L28-L64)
...
- [server_runtime.py:647-800](file://rdc_tool/server_runtime.py#L647-L800)

### 配置与环境（RdcToolConfig）
- 环境变量覆盖：
  - RDC_TOOL_RENDERDOC_PATH：补充renderdoc模块路径。
  - RDC_TOOL_ARTIFACT_STORE/RDC_TOOL_DATA_DIR/RDC_TOOL_REPORT_DIR：工件、数据库、报告输出路径。
  - RDC_TOOL_LOG_LEVEL：日志级别。
  - RDC_TOOL_GPU_VENDOR/RDC_TOOL_SPIRV_TOOLS_PATH/RDC_TOOL_HEADLESS：后端与编译工具相关。
  - RDC_TOOL_BISECT_*：二分搜索策略与置信度权重。
  - RDC_TOOL_CONTEXT_ARTIFACT_*：上下文工件保留限制。
  - RDC_TOOL_MAX_*：运行时限制（上下文、会话、捕获文件大小、内存估计等）。
- 配置结构：
...
章节来源
- [runtime_state.py:104-149](file://rdc_tool/runtime_state.py#L104-L149)
- [runtime_state.py:255-290](file://rdc_tool/runtime_state.py#L255-L290)
- [runtime_state.py:448-472](file://rdc_tool/runtime_state.py#L448-L472)
...
- [runtime_state.py:448-472](file://rdc_tool/runtime_state.py#L448-L472)
- [config.py:136-186](file://rdc_tool/config.py#L136-L186)
...
- 自定义工具构建：
  ...
  - 配置注入：通过RdcToolConfig与环境变量暴露可调参数，保持灵活性与可测试性。
