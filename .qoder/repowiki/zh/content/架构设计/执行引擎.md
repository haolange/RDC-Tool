...
## 项目结构
执行引擎位于 rdx/core 下，以 CoreEngine 为中心，配合 OperationRegistry 进行处理器注册与分发，通过 contracts 生成统一响应信封，借助 ArtifactPublisher 产出产物引用，并通过 errors 完成异常到标准错误的转换。handlers.core 作为入口将外部调用路由到 server_runtime._dispatch_core，最终由 CoreEngine 驱动执行。
...
章节来源
- [core.py:8-10](file://rdx/handlers/core.py#L8-L10)
- [engine.py:21-75](file://rdx/core/engine.py#L21-L75)
- [operation_registry.py:18-43](file://rdx/core/operation_registry.py#L18-L43)
- [contracts.py:98-164](file://rdx/core/contracts.py#L98-L164)
- [artifact_publisher.py:60-118](file://rdx/core/artifact_publisher.py#L60-L118)
- [errors.py:90-119](file://rdx/core/errors.py#L90-L119)
...
- [operation_registry.py:18-43](file://rdx/core/operation_registry.py#L18-L43)
- [contracts.py:98-164](file://rdx/core/contracts.py#L98-L164)
- [artifact_publisher.py:15-118](file://rdx/core/artifact_publisher.py#L15-L118)
- [errors.py:9-119](file://rdx/core/errors.py#L9-L119)
- [progress.py:14-84](file://rdx/progress.py#L14-L84)
- [core.py:8-10](file://rdx/handlers/core.py#L8-L10)
...
图表来源
- [engine.py:40-75](file://rdx/core/engine.py#L40-L75)
- [engine.py:77-203](file://rdx/core/engine.py#L77-L203)
- [errors.py:90-119](file://rdx/core/errors.py#L90-L119)
- [contracts.py:98-164](file://rdx/core/contracts.py#L98-L164)
...
图表来源
- [engine.py:21-28](file://rdx/core/engine.py#L21-L28)
- [progress.py:14-84](file://rdx/progress.py#L14-L84)
...
章节来源
- [errors.py:9-119](file://rdx/core/errors.py#L9-L119)
- [engine.py:62-75](file://rdx/core/engine.py#L62-L75)
- [contracts.py:98-164](file://rdx/core/contracts.py#L98-L164)
...
章节来源
- [operation_registry.py:18-43](file://rdx/core/operation_registry.py#L18-L43)
- [engine.py:51-54](file://rdx/core/engine.py#L51-L54)

### 产物发布策略
- 模式控制：通过环境变量 RDX_ARTIFACT_MODE 控制 local/remote；RDX_REMOTE_ARTIFACT_MIN_BYTES 控制远端上传阈值。
...
- 建议：
  ...
  - 合理设置 RDX_REMOTE_ARTIFACT_MIN_BYTES，平衡网络与存储成本。
  - 结合 meta.duration_ms 与日志级别，定位慢操作。

章节来源
- [engine.py:47-61](file://rdx/core/engine.py#L47-L61)
- [progress.py:14-84](file://rdx/progress.py#L14-L84)
- [artifact_publisher.py:15-34](file://rdx/core/artifact_publisher.py#L15-L34)
...
- [errors.py:9-119](file://rdx/core/errors.py#L9-L119)
- [engine.py:62-75](file://rdx/core/engine.py#L62-L75)
- [contracts.py:129-164](file://rdx/core/contracts.py#L129-L164)
