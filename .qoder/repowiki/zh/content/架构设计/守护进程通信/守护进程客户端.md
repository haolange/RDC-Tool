...
- 客户端实现：rdc_tool/daemon/client.py
- 守护进程服务：rdc_tool/daemon/server.py
- 工作进程生命周期：rdc_tool/daemon/worker.py
- 全局配置与环境变量：rdc_tool/config.py
...
章节来源
- [rdc_tool/daemon/client.py:1-902](file://rdc_tool/daemon/client.py#L1-L902)
- [rdc_tool/daemon/server.py:1-728](file://rdc_tool/daemon/server.py#L1-L728)
- [rdc_tool/daemon/worker.py:1-203](file://rdc_tool/daemon/worker.py#L1-L203)
...
章节来源
- [rdc_tool/daemon/client.py:467-515](file://rdc_tool/daemon/client.py#L467-L515)
- [rdc_tool/daemon/server.py:102-176](file://rdc_tool/daemon/server.py#L102-L176)
- [rdc_tool/daemon/worker.py:24-170](file://rdc_tool/daemon/worker.py#L24-L170)
...
图表来源
- [rdc_tool/daemon/client.py:754-834](file://rdc_tool/daemon/client.py#L754-L834)
- [rdc_tool/daemon/server.py:376-450](file://rdc_tool/daemon/server.py#L376-L450)
...
- execute / exec：执行操作，参数包含 operation 与 args，支持 transport 与 remote 标记。
  - 参考路径：[rdc_tool/daemon/client.py:467-515](file://rdc_tool/daemon/client.py#L467-L515)
- attach：附加客户端，参数包含 client_id、client_type、pid、lease_timeout_seconds。
  - 参考路径：[rdc_tool/daemon/client.py:754-789](file://rdc_tool/daemon/client.py#L754-L789)
- heartbeat：心跳保持，参数包含 client_id、pid。
  - 参考路径：[rdc_tool/daemon/client.py:792-812](file://rdc_tool/daemon/client.py#L792-L812)
- detach：分离客户端，参数包含 client_id。
  - 参考路径：[rdc_tool/daemon/client.py:815-834](file://rdc_tool/daemon/client.py#L815-L834)
- clear_context：清理上下文，无守护进程时直接清理本地状态。
  - 参考路径：[rdc_tool/daemon/client.py:837-871](file://rdc_tool/daemon/client.py#L837-L871)
- stop_daemon：停止守护进程与工作进程，清理状态。
  - 参考路径：[rdc_tool/daemon/client.py:874-902](file://rdc_tool/daemon/client.py#L874-L902)
- ensure_daemon/start_daemon：确保守护进程运行，必要时启动并等待就绪。
  - 参考路径：[rdc_tool/daemon/client.py:623-733](file://rdc_tool/daemon/client.py#L623-L733)

章节来源
- [rdc_tool/daemon/client.py:467-902](file://rdc_tool/daemon/client.py#L467-L902)

### 配置选项与环境变量
- 守护进程启动参数：pipe_name、token、daemon_context、owner_pid、lease_timeout_seconds、idle_timeout_seconds。
  - 参考路径：[rdc_tool/daemon/client.py:665-681](file://rdc_tool/daemon/client.py#L665-L681)
- 环境变量影响：
  - RDC_TOOL_ROOT：设置Python路径前缀，便于导入工具模块。
  - RDC_TOOL_CONTEXT_ID、RDC_TOOL_DAEMON_PID、RDC_TOOL_RUNTIME_DLL_DIR、RDC_TOOL_RENDERDOC_PATH、RDC_TOOL_WORKER_SOURCE_MANIFEST：工作进程环境。
  - 其他配置项（如日志级别、GPU厂商、存储路径等）在 config.py 中定义。
  - 参考路径：[rdc_tool/daemon/worker.py:78-89](file://rdc_tool/daemon/worker.py#L78-L89)
  - 参考路径：[rdc_tool/config.py:135-185](file://rdc_tool/config.py#L135-L185)

章节来源
- [rdc_tool/daemon/client.py:665-681](file://rdc_tool/daemon/client.py#L665-L681)
- [rdc_tool/daemon/worker.py:78-89](file://rdc_tool/daemon/worker.py#L78-L89)
...
- 常见错误与定位：
  ...
  - 未授权：token不匹配导致 unauthorized。
    - 参考路径：[rdc_tool/daemon/server.py:166-169](file://rdc_tool/daemon/server.py#L166-L169)
  - 未知方法：unknown_method。
    - 参考路径：[rdc_tool/daemon/server.py:643-643](file://rdc_tool/daemon/server.py#L643-L643)
  - 工作进程错误：worker_error，包含异常消息。
    - 参考路径：[rdc_tool/daemon/server.py:480-483](file://rdc_tool/daemon/server.py#L480-L483)
- 自动恢复：
  - cleanup_stale_daemon_states 清理僵尸状态并终止残留进程。
    - 参考路径：[rdc_tool/daemon/client.py:554-607](file://rdc_tool/daemon/client.py#L554-L607)
...
章节来源
- [rdc_tool/daemon/client.py:554-607](file://rdc_tool/daemon/client.py#L554-L607)
- [rdc_tool/daemon/client.py:623-733](file://rdc_tool/daemon/client.py#L623-L733)
- [rdc_tool/daemon/server.py:166-169](file://rdc_tool/daemon/server.py#L166-L169)
- [rdc_tool/daemon/server.py:480-483](file://rdc_tool/daemon/server.py#L480-L483)
- [rdc_tool/daemon/server.py:643-643](file://rdc_tool/daemon/server.py#L643-L643)
...
- 配置与环境变量：
  - 守护进程参数：pipe_name、token、daemon_context、owner_pid、lease_timeout_seconds、idle_timeout_seconds。
    - 参考路径：[rdc_tool/daemon/client.py:665-681](file://rdc_tool/daemon/client.py#L665-L681)
  - 环境变量：RDC_TOOL_ROOT、RDC_TOOL_CONTEXT_ID、RDC_TOOL_DAEMON_PID、RDC_TOOL_RUNTIME_DLL_DIR、RDC_TOOL_RENDERDOC_PATH、RDC_TOOL_WORKER_SOURCE_MANIFEST。
    - 参考路径：[rdc_tool/daemon/worker.py:78-89](file://rdc_tool/daemon/worker.py#L78-L89)
