...
- [daemon/worker.py](file://rdc_tool/daemon/worker.py)
...
- [core/engine.py](file://rdc_tool/core/engine.py)
...
## 简介
本文件围绕 RDC 的“工作进程”（RenderDoc-backed runtime worker）进行系统化文档化，重点解释 RuntimeWorkerProcess 的设计模式与实现机制，覆盖以下主题：
...
图表来源
- [daemon/worker.py:24-203](file://rdc_tool/daemon/worker.py#L24-L203)
...
- [core/engine.py:30-76](file://rdc_tool/core/engine.py#L30-L76)
...
图表来源
- [daemon/worker.py:144-170](file://rdc_tool/daemon/worker.py#L144-L170)
- [runtime_worker.py:97-155](file://rdc_tool/runtime_worker.py#L97-L155)
- [server.py:62-145](file://rdc_tool/server.py#L62-L145)
- [core/engine.py:40-76](file://rdc_tool/core/engine.py#L40-L76)
...
图表来源
- [daemon/worker.py:57-136](file://rdc_tool/daemon/worker.py#L57-L136)
- [daemon/worker.py:144-170](file://rdc_tool/daemon/worker.py#L144-L170)

章节来源
- [runtime_worker.py:25-63](file://rdc_tool/runtime_worker.py#L25-L63)
- [runtime_worker.py:65-167](file://rdc_tool/runtime_worker.py#L65-L167)
- [daemon/worker.py:57-136](file://rdc_tool/daemon/worker.py#L57-L136)
- [daemon/worker.py:144-170](file://rdc_tool/daemon/worker.py#L144-L170)
...
- 启动流程
  ...
  - 工作进程设置 RDC_TOOL_CONTEXT_ID，启动父进程守护线程，上报 ready 状态
- 监控机制
...
图表来源
- [daemon/worker.py:138-203](file://rdc_tool/daemon/worker.py#L138-L203)
- [runtime_worker.py:56-63](file://rdc_tool/runtime_worker.py#L56-L63)
- [runtime_worker.py:150-161](file://rdc_tool/runtime_worker.py#L150-L161)

章节来源
- [daemon/worker.py:69-136](file://rdc_tool/daemon/worker.py#L69-L136)
- [daemon/worker.py:138-203](file://rdc_tool/daemon/worker.py#L138-L203)
- [runtime_worker.py:56-63](file://rdc_tool/runtime_worker.py#L56-L63)
- [runtime_worker.py:150-161](file://rdc_tool/runtime_worker.py#L150-L161)
...
图表来源
- [runtime_worker.py:111-122](file://rdc_tool/runtime_worker.py#L111-L122)
- [server.py:62-145](file://rdc_tool/server.py#L62-L145)
- [core/engine.py:40-76](file://rdc_tool/core/engine.py#L40-L76)
...
图表来源
- [runtime_worker_state.py:19-56](file://rdc_tool/runtime_worker_state.py#L19-L56)
- [daemon/client.py:554-606](file://rdc_tool/daemon/client.py#L554-L606)
...
图表来源
- [core/engine.py:40-76](file://rdc_tool/core/engine.py#L40-L76)
- [operation_definitions.py:376-393](file://rdc_tool/operation_definitions.py#L376-L393)
...
图表来源
- [daemon/worker.py:121-136](file://rdc_tool/daemon/worker.py#L121-L136)
- [daemon/worker.py:138-170](file://rdc_tool/daemon/worker.py#L138-L170)
- [runtime_worker_state.py:46-56](file://rdc_tool/runtime_worker_state.py#L46-L56)
...
图表来源
- [runtime_worker.py:72-122](file://rdc_tool/runtime_worker.py#L72-L122)
- [server.py:26-47](file://rdc_tool/server.py#L26-L47)
- [daemon/worker.py:16-18](file://rdc_tool/daemon/worker.py#L16-L18)
...
## 结论
RDC 的工作进程管理通过守护进程与工作进程的隔离架构，实现了稳定的 RenderDoc 运行时执行环境。通过 JSON 行协议、状态持久化、监控接口与故障恢复策略，系统具备高可用性与可观测性。在多上下文场景下，结合容量限制与回收策略，可有效管理资源并提升整体性能。

[本节为总结，不直接分析具体文件]

## 附录
- 环境变量说明
  - RDC_TOOL_CONTEXT_ID：上下文标识
  - RDC_TOOL_DAEMON_PID：守护进程 PID
  - RDC_TOOL_RUNTIME_DLL_DIR：二进制目录
  - RDC_TOOL_RENDERDOC_PATH：Python 模块目录
  - RDC_TOOL_WORKER_SOURCE_MANIFEST：源清单路径
- 关键常量
  - READY_TIMEOUT_S：工作进程就绪超时
  - REQUEST_TIMEOUT_S：请求超时

章节来源
- [daemon/worker.py:20-22](file://rdc_tool/daemon/worker.py#L20-L22)
- [daemon/worker.py:78-84](file://rdc_tool/daemon/worker.py#L78-L84)