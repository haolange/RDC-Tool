...
## 项目结构
守护进程相关代码主要分布在以下模块：
- 守护进程服务端：rdc_tool/daemon/server.py
- 守护进程客户端与状态管理：rdc_tool/daemon/client.py
- 工作进程封装：rdc_tool/daemon/worker.py
- 工作进程实际执行器：rdc_tool/runtime_worker.py
- 上下文快照与运行时状态：rdc_tool/context_snapshot.py、rdc_tool/runtime_state.py
- 超时策略：rdc_tool/timeout_policy.py
- 运行时调度与服务：rdc_tool/server_runtime.py
- 路径与环境：rdc_tool/runtime_paths.py
...
- [rdc_tool/daemon/client.py:467-733](file://rdc_tool/daemon/client.py#L467-L733)
...
- [rdc_tool/context_snapshot.py:214-475](file://rdc_tool/context_snapshot.py#L214-L475)
...
图表来源
- [rdc_tool/daemon/server.py:166-176](file://rdc_tool/daemon/server.py#L166-L176)
...
图表来源
- [rdc_tool/daemon/server.py:171-176](file://rdc_tool/daemon/server.py#L171-L176)
...
- 进程创建：RuntimeWorkerProcess._spawn设置环境变量（RDC_TOOL_CONTEXT_ID、RDC_TOOL_DAEMON_PID、RDC_TOOL_RUNTIME_DLL_DIR、RDC_TOOL_RENDERDOC_PATH、RDC_TOOL_WORKER_SOURCE_MANIFEST），启动子进程执行rdc_tool.runtime_worker。
...
- [rdc_tool/daemon/server.py:532-570](file://rdc_tool/daemon/server.py#L532-L570)
- [rdc_tool/daemon/client.py:402-415](file://rdc_tool/daemon/client.py#L402-L415)
- [rdc_tool/timeout_policy.py:56-104](file://rdc_tool/timeout_policy.py#L56-L104)
...
章节来源
- [rdc_tool/daemon/server.py:572-643](file://rdc_tool/daemon/server.py#L572-L643)
- [rdc_tool/daemon/server.py:452-530](file://rdc_tool/daemon/server.py#L452-L530)
...
- [rdc_tool/timeout_policy.py:56-104](file://rdc_tool/timeout_policy.py#L56-L104)
- [rdc_tool/daemon/worker.py:144-170](file://rdc_tool/daemon/worker.py#L144-L170)
- [rdc_tool/daemon/client.py:467-516](file://rdc_tool/daemon/client.py#L467-L516)
- [rdc_tool/daemon/server.py:227-245](file://rdc_tool/daemon/server.py#L227-L245)
...
- [rdc_tool/runtime_state.py:448-473](file://rdc_tool/runtime_state.py#L448-L473)
