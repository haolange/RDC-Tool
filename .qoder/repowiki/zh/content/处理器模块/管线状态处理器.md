...
## 项目结构
RDC 工具通过分层设计将管线状态能力封装在核心服务中，并通过运行时调度暴露为统一操作接口：
...
```mermaid
graph TB
CLI["命令行接口<br/>rdc cli"] --> H_P["管线处理器<br/>handlers/pipeline.py"]
...
- [server_runtime.py:9518-9717](file://rdc_tool/server_runtime.py#L9518-L9717)
...
章节来源
- [pipeline_service.py:590-874](file://rdc_tool/core/pipeline_service.py#L590-L874)
- [server_runtime.py:7461-7621](file://rdc_tool/server_runtime.py#L7461-L7621)
- [server_runtime.py:9518-9717](file://rdc_tool/server_runtime.py#L9518-L9717)
- [models.py:224-313](file://rdc_tool/models.py#L224-L313)
- [pipeline.py:1-11](file://rdc_tool/handlers/pipeline.py#L1-L11)
- [shader.py:1-11](file://rdc_tool/handlers/shader.py#L1-L11)
- [cli.py:971-983](file://rdc_tool/cli.py#L971-L983)
...
U->>C : 执行 rdc-tool pipeline shader ...
C->>H : 解析参数并构造动作
...
图表来源
- [pipeline_service.py:708-832](file://rdc_tool/core/pipeline_service.py#L708-L832)
- [server_runtime.py:9518-9717](file://rdc_tool/server_runtime.py#L9518-L9717)
...
图表来源
- [models.py:232-300](file://rdc_tool/models.py#L232-L300)
- [pipeline_service.py:392-502](file://rdc_tool/core/pipeline_service.py#L392-L502)
- [pipeline_service.py:838-869](file://rdc_tool/core/pipeline_service.py#L838-L869)
...
章节来源
- [server_runtime.py:7504-7549](file://rdc_tool/server_runtime.py#L7504-L7549)
- [server_runtime.py:7603-7621](file://rdc_tool/server_runtime.py#L7603-L7621)
- [pipeline_service.py:621-683](file://rdc_tool/core/pipeline_service.py#L621-L683)
...
- [server_runtime.py:230-238](file://rdc_tool/server_runtime.py#L230-L238)
- [models.py:224-313](file://rdc_tool/models.py#L224-L313)
...
- 常用命令：rdc-tool pipeline section --stage ps；rdc-tool shader source/disasm/constants --stage ps；rdc-tool export screenshot/texture/buffer/mesh。
