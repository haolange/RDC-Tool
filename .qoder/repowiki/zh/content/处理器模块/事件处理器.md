...
## 简介
本文件聚焦于 RDC 工具的事件处理子系统，围绕“GPU 事件导航与查询”“Drawcall 遍历与状态/资源绑定监控”“Action 树遍历算法（深度优先、条件过滤、性能优化）”“API 调用检查（OpenGL/Vulkan/D3D 等）”展开。文档同时给出事件模型设计原理、查询语法规范、性能调优建议，并提供实际使用示例以定位 GPU 调用分析与性能瓶颈。

## 项目结构
RDC 的事件处理由“处理器入口 → 运行时调度 → 会话管理 → 事件图构建与查询 → 渲染/性能服务”构成。关键路径如下：
...
- [server.py:62-91](file://rdc_tool/server.py#L62-L91)
- [session_manager.py:260-270](file://rdc_tool/core/session_manager.py#L260-L270)
- [event_graph.py:152-191](file://rdc_tool/core/event_graph.py#L152-L191)
...
- [event_graph.py:313-386](file://rdc_tool/core/event_graph.py#L313-L386)
...
- [event_graph.py:195-309](file://rdc_tool/core/event_graph.py#L195-L309)
...
**图示来源**
- [perf_service.py:28-63](file://rdc_tool/core/perf_service.py#L28-L63)
- [perf_service.py:493-602](file://rdc_tool/core/perf_service.py#L493-L602)
...
**章节来源**
- [capture_queries.py:73-119](file://rdc_tool/core/capture_queries.py#L73-L119)
- [session_manager.py:33-65](file://rdc_tool/core/session_manager.py#L33-L65)
...
**章节来源**
- [experiment_runner.py:144-176](file://rdc_tool/core/experiment_runner.py#L144-L176)
- [experiment_runner.py:269-762](file://rdc_tool/core/experiment_runner.py#L269-L762)
...
**图示来源**
- [render_service.py:64-90](file://rdc_tool/core/render_service.py#L64-L90)
- [perf_service.py:73-89](file://rdc_tool/core/perf_service.py#L73-L89)
- [session_manager.py:171-173](file://rdc_tool/core/session_manager.py#L171-L173)
...
- [perf_service.py:33-37](file://rdc_tool/core/perf_service.py#L33-L37)
- [capture_queries.py:76-78](file://rdc_tool/core/capture_queries.py#L76-L78)
- [session_manager.py:373-440](file://rdc_tool/core/session_manager.py#L373-L440)

## 结论
RDC 的事件处理器通过清晰的层次化设计与模块化服务，实现了高效的 GPU 事件导航、Drawcall 遍历、状态/资源绑定监控、API 调用检查与性能分析。借助深度优先遍历、条件过滤与预算控制，系统在大规模捕获中仍保持良好性能。结合渲染与像素分析能力，用户可快速定位性能瓶颈与渲染问题。
...
**章节来源**
- [session_manager.py:175-251](file://rdc_tool/core/session_manager.py#L175-L251)
- [event_graph.py:161-309](file://rdc_tool/core/event_graph.py#L161-L309)
- [perf_service.py:28-63](file://rdc_tool/core/perf_service.py#L28-L63)
- [perf_service.py:493-602](file://rdc_tool/core/perf_service.py#L493-L602)
- [render_service.py:357-521](file://rdc_tool/core/render_service.py#L357-L521)
- [render_service.py:658-769](file://rdc_tool/core/render_service.py#L658-L769)
