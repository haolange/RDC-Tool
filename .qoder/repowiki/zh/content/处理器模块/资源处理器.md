...
```mermaid
graph TB
CLI["命令行接口<br/>rdx cli.py"] --> Server["操作分发器<br/>server.py"]
...
**图示来源**
- [server.py:62-142](file://rdx/server.py#L62-L142)
...
- [perf_service.py:212-487](file://rdx/core/perf_service.py#L212-L487)
- [session_manager.py:148-293](file://rdx/core/session_manager.py#L148-L293)
- [models.py:117-122](file://rdx/models.py#L117-L122)
...
**图示来源**
- [cli.py:1012-1020](file://rdx/cli.py#L1012-L1020)
- [server.py:62-142](file://rdx/server.py#L62-L142)
- [server_runtime.py:196-239](file://rdx/server_runtime.py#L196-L239)
...
- [render_service.py:658-794](file://rdx/core/render_service.py#L658-L794)
- [session_manager.py:260-273](file://rdx/core/session_manager.py#L260-L273)
...
**图示来源**
- [models.py:224-230](file://rdx/models.py#L224-L230)
- [models.py:232-245](file://rdx/models.py#L232-L245)
- [models.py:280-301](file://rdx/models.py#L280-L301)

**章节来源**
- [models.py:224-301](file://rdx/models.py#L224-L301)
- [cli.py:971-995](file://rdx/cli.py#L971-L995)
...
**图示来源**
- [server_runtime.py:624-645](file://rdx/server_runtime.py#L624-L645)
- [server_runtime.py:647-654](file://rdx/server_runtime.py#L647-L654)
...
**图示来源**
- [models.py:173-181](file://rdx/models.py#L173-L181)
- [models.py:280-301](file://rdx/models.py#L280-L301)
- [render_service.py:658-794](file://rdx/core/render_service.py#L658-L794)
...
- [perf_service.py:235-487](file://rdx/core/perf_service.py#L235-L487)
- [server_runtime.py:397-410](file://rdx/server_runtime.py#L397-L410)
...
## 附录：使用示例
- 资源列表与详情
  - 列出资源：rdx resource list --format tsv
  - 查看资源详情：rdx resource show --resource-id <id> --format json
- 纹理像素调试
  - 读取像素值：rdx pixel value --event-id 42 --resource-id <tex-id> --x 320 --y 180 --format json
  - 查看像素历史：rdx pixel history --event-id 42 --resource-id <tex-id> --x 320 --y 180 --format json
- 导出与可视化
  - 导出纹理：rdx export texture --resource-id <id> --out out.png
  - 导出缓冲：rdx export buffer --resource-id <id> --out out.raw
- 性能与热点
  - 枚举计数器：rdx perf counters --format json
  - 采样计数器：rdx perf sample --event-range 1,1000 --counter-ids <ids> --format json
  - 检测热点：rdx perf hotspots --top-k 10 --format json
