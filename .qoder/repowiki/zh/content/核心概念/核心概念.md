...
## 简介
本文件面向希望深入理解 RDC-Tool（rdx-tools）内部模型与运行机制的开发者。围绕 RenderDoc 捕获文件 .rdc 的格式与生命周期、Replay 会话模型、上下文快照机制、Agent 自动化模型、GPU 事件模型、管线状态与着色器调试等主题，给出从数据模型到控制流、从本地到远端的完整说明，并辅以代码级图示与可追溯来源。

## 项目结构
RDC-Tool 采用“CLI + 守护进程 + 运行时”的分层组织：
- CLI 入口通过 rdx 命令暴露 JSON-first 操作；工具集由代码生成目录与注册表驱动。
- 核心服务位于 rdx/core，封装 RenderDoc 回放、渲染读回、差异对比、性能统计等能力。
...
```mermaid
graph TB
CLI["命令行 rdx"] --> Handlers["处理器 handlers/*"]
...
- [models.py:163-180](file://rdx/models.py#L163-L180)
- [models.py:224-301](file://rdx/models.py#L224-L301)
- [models.py:319-332](file://rdx/models.py#L319-L332)
- [models.py:338-385](file://rdx/models.py#L338-L385)
- [models.py:391-423](file://rdx/models.py#L391-L423)
- [models.py:429-457](file://rdx/models.py#L429-L457)
- [models.py:463-483](file://rdx/models.py#L463-L483)
- [models.py:489-503](file://rdx/models.py#L489-L503)
- [models.py:510-552](file://rdx/models.py#L510-L552)
- [models.py:558-584](file://rdx/models.py#L558-L584)
- [session_manager.py:118-146](file://rdx/core/session_manager.py#L118-L146)
- [session_manager.py:148-259](file://rdx/core/session_manager.py#L148-L259)
- [render_service.py:346-521](file://rdx/core/render_service.py#L346-L521)
- [context_snapshot.py:18-34](file://rdx/context_snapshot.py#L18-L34)
...
**图表来源**
- [context_snapshot.py:18-34](file://rdx/context_snapshot.py#L18-L34)
- [context_snapshot.py:83-171](file://rdx/context_snapshot.py#L83-L171)
- [context_snapshot.py:242-279](file://rdx/context_snapshot.py#L242-L279)
- [context_snapshot.py:335-364](file://rdx/context_snapshot.py#L335-L364)
- [context_snapshot.py:447-475](file://rdx/context_snapshot.py#L447-L475)
...
### Agent 模型与自动化
- 原则：以 CLI-only 方式与 rdx 交互；通过 tools list/describe 发现能力；通过 context status/update 维护任务连续性。
...
participant C as "rdx CLI"
participant D as "守护进程"
A->>C : rdx tools list/search/describe
C->>D : 查询工具目录/描述
D-->>C : JSON 目录/描述
A->>C : rdx context status/update
C->>D : 读取/更新上下文快照
D-->>C : 返回上下文
A->>C : 执行 rd.* 操作
C->>D : 转发操作
