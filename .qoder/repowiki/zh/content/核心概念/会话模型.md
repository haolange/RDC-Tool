...
- rdx/core/session_manager.py：会话管理器，封装本地/远端渲染后端初始化、捕获打开、无头输出创建、清理等。
- rdx/server_runtime.py：运行时服务，维护上下文状态、会话映射、预览绑定、远程句柄、快照同步等。
- rdx/context_snapshot.py：上下文快照持久化与归一化，支持用户字段与运行时字段分离、保留策略。
- rdx/replay_observation.py：嵌入式回放观察，导出 PNG、选择事件与目标、判定最终输出。
- rdx/remote_bootstrap.py：Android 辅助工具引导，设备发现、APK 安装、端口转发、进程所有权与清理。
- rdx/preview_window.py：Windows 预览窗口宿主，帧缓冲几何适配、窗口尺寸调整、消息循环。
- rdx/models.py：会话能力、捕获信息、事件树等数据模型。
- rdx/runtime_worker.py：独立工作进程，维持一个事件循环与单线程执行器以保障原生线程亲和性。
...
**图表来源**
- [server_runtime.py:196-239](file://rdx/server_runtime.py#L196-L239)
- [session_manager.py:148-207](file://rdx/core/session_manager.py#L148-L207)
...
- [remote_bootstrap.py:495-699](file://rdx/remote_bootstrap.py#L495-L699)
- [preview_window.py:192-301](file://rdx/preview_window.py#L192-L301)
...
- [replay_observation.py:16-37](file://rdx/replay_observation.py#L16-L37)
- [remote_bootstrap.py:83-121](file://rdx/remote_bootstrap.py#L83-L121)
- [preview_window.py:192-301](file://rdx/preview_window.py#L192-L301)
...
**图表来源**
- [session_manager.py:175-259](file://rdx/core/session_manager.py#L175-L259)
- [session_manager.py:301-441](file://rdx/core/session_manager.py#L301-L441)
...
**章节来源**
- [context_snapshot.py:18-35](file://rdx/context_snapshot.py#L18-L35)
- [context_snapshot.py:214-279](file://rdx/context_snapshot.py#L214-L279)
- [context_snapshot.py:367-444](file://rdx/context_snapshot.py#L367-L444)
...
**图表来源**
- [preview_window.py:91-129](file://rdx/preview_window.py#L91-L129)
- [preview_window.py:274-301](file://rdx/preview_window.py#L274-L301)
- [server_runtime.py:562-621](file://rdx/server_runtime.py#L562-L621)

**章节来源**
- [preview_window.py:192-301](file://rdx/preview_window.py#L192-L301)
- [server_runtime.py:471-531](file://rdx/server_runtime.py#L471-L531)
- [server_runtime.py:562-621](file://rdx/server_runtime.py#L562-L621)
...
**图表来源**
- [remote_bootstrap.py:294-338](file://rdx/remote_bootstrap.py#L294-L338)
- [remote_bootstrap.py:495-699](file://rdx/remote_bootstrap.py#L495-L699)
- [remote_bootstrap.py:701-754](file://rdx/remote_bootstrap.py#L701-L754)
...
- [session_manager.py:27-31](file://rdx/core/session_manager.py#L27-L31)
- [replay_observation.py:11-12](file://rdx/replay_observation.py#L11-L12)
- [remote_bootstrap.py:17-18](file://rdx/remote_bootstrap.py#L17-L18)
...
**章节来源**
- [session_manager.py:185-224](file://rdx/core/session_manager.py#L185-L224)
- [session_manager.py:399-441](file://rdx/core/session_manager.py#L399-L441)
- [replay_observation.py:55-68](file://rdx/replay_observation.py#L55-L68)
- [replay_observation.py:122-147](file://rdx/replay_observation.py#L122-L147)
- [remote_bootstrap.py:156-202](file://rdx/remote_bootstrap.py#L156-L202)
- [remote_bootstrap.py:661-699](file://rdx/remote_bootstrap.py#L661-L699)
...
## 附录：API调用模式与示例路径
- 创建会话：参考 [session_manager.py:175-207](file://rdx/core/session_manager.py#L175-L207)
- 打开捕获：参考 [session_manager.py:208-251](file://rdx/core/session_manager.py#L208-L251)
- 切换事件：参考 [replay_observation.py:91-94](file://rdx/replay_observation.py#L91-L94)
- 导出 PNG：参考 [replay_observation.py:55-147](file://rdx/replay_observation.py#L55-L147)
- 预览窗口：参考 [preview_window.py:221-301](file://rdx/preview_window.py#L221-L301)
- Android 引导：参考 [remote_bootstrap.py:495-699](file://rdx/remote_bootstrap.py#L495-L699)
- 上下文快照：参考 [context_snapshot.py:447-541](file://rdx/context_snapshot.py#L447-L541)
- 工作进程：参考 [runtime_worker.py:65-167](file://rdx/runtime_worker.py#L65-L167)

**章节来源**
- [session_manager.py:175-251](file://rdx/core/session_manager.py#L175-L251)
- [replay_observation.py:55-147](file://rdx/replay_observation.py#L55-L147)
- [preview_window.py:221-301](file://rdx/preview_window.py#L221-L301)
- [remote_bootstrap.py:495-699](file://rdx/remote_bootstrap.py#L495-L699)
- [context_snapshot.py:447-541](file://rdx/context_snapshot.py#L447-L541)
- [runtime_worker.py:65-167](file://rdx/runtime_worker.py#L65-L167)