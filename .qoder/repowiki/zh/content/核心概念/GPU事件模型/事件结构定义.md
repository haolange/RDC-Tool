...
- rdc_tool/models.py：定义事件节点、标志位、管线快照、资源绑定条目等数据模型。
- rdc_tool/core/event_graph.py：负责从 RenderDoc 回放控制器构建事件树，提供 draw/dispatch 收集、范围查询、路径查找与 Pass 推断。
- rdc_tool/core/pipeline_service.py：在指定事件处读取管线状态（着色器、渲染目标、混合/深度模板、资源绑定、视口/裁剪等）。
- rdc_tool/operation_definitions.py：对外工具接口契约，包含事件导航、mesh 配置、纹理采样等 API 的参数与返回约定。
- rdc_tool/server.py：运行时调度入口，统一封装操作执行与上下文同步。
- rdc_tool/core/perf_service.py：基于 RenderDoc 计数器获取整段回放的 GPU 耗时样本，用于事件级性能分析。
...
图表来源
- [server.py:1-120](file://rdc_tool/server.py#L1-L120)
...
- [operation_definitions.py:1013-1048](file://rdc_tool/operation_definitions.py#L1013-L1048)
...
- [models.py:232-299](file://rdc_tool/models.py#L232-L299)
- [event_graph.py:152-191](file://rdc_tool/core/event_graph.py#L152-L191)
...
章节来源
- [models.py:163-181](file://rdc_tool/models.py#L163-L181)
- [event_graph.py:66-96](file://rdc_tool/core/event_graph.py#L66-L96)
...
图表来源
- [event_graph.py:195-248](file://rdc_tool/core/event_graph.py#L195-L248)
...
章节来源
- [event_graph.py:66-96](file://rdc_tool/core/event_graph.py#L66-L96)
- [operation_definitions.py:1540-1559](file://rdc_tool/operation_definitions.py#L1540-L1559)
...
- [event_graph.py:152-191](file://rdc_tool/core/event_graph.py#L152-L191)
- [pipeline_service.py:175-186](file://rdc_tool/core/pipeline_service.py#L175-L186)
- [perf_service.py:33-63](file://rdc_tool/core/perf_service.py#L33-L63)
...
章节来源
- [event_graph.py:107-145](file://rdc_tool/core/event_graph.py#L107-L145)
- [perf_service.py:33-63](file://rdc_tool/core/perf_service.py#L33-L63)
