...
- rdx/core/event_graph.py：事件图服务，负责从 RenderDoc 的 ActionDescription 树构建 EventNode 树，提供查询、路径回溯与 Pass 推断能力。
- rdx/models.py：事件节点与标志位的数据模型，定义了 EventNode、EventFlags 等核心结构。
- rdx/operation_definitions.py：对外暴露的工具操作定义，包括 rd.event.search_actions、rd.event.get_action_tree、rd.event.get_action_details 等，用于事件搜索、树遍历与详情获取。
- rdx/core/capture_queries.py：读取捕获元数据与结构化调用，支持按事件定位并分页读取结构化对象。
- rdx/replay_observation.py：回放观测相关逻辑，包含设置 active event、输出目标解析等。
...
- [operation_definitions.py:902-1149](file://rdx/operation_definitions.py#L902-L1149)
- [capture_queries.py:73-119](file://rdx/core/capture_queries.py#L73-L119)
- [replay_observation.py:91-109](file://rdx/replay_observation.py#L91-L109)
...
- [event_graph.py:313-335](file://rdx/core/event_graph.py#L313-L335)
- [models.py:163-181](file://rdx/models.py#L163-L181)
- [operation_definitions.py:951-967](file://rdx/operation_definitions.py#L951-L967)
...
图表来源
- [event_graph.py:195-216](file://rdx/core/event_graph.py#L195-L216)
- [event_graph.py:252-309](file://rdx/core/event_graph.py#L252-L309)
- [event_graph.py:337-365](file://rdx/core/event_graph.py#L337-L365)
...
图表来源
- [operation_definitions.py:1112-1141](file://rdx/operation_definitions.py#L1112-L1141)
...
章节来源
- [operation_definitions.py:951-967](file://rdx/operation_definitions.py#L951-L967)
- [operation_definitions.py:902-911](file://rdx/operation_definitions.py#L902-L911)
...
章节来源
- [event_graph.py:107-146](file://rdx/core/event_graph.py#L107-L146)
- [event_graph.py:218-248](file://rdx/core/event_graph.py#L218-L248)
- [capture_queries.py:73-119](file://rdx/core/capture_queries.py#L73-L119)
...
- 参考路径：
  - [operation_definitions.py:902-911](file://rdx/operation_definitions.py#L902-L911)
  - [event_graph.py:235-248](file://rdx/core/event_graph.py#L235-L248)
