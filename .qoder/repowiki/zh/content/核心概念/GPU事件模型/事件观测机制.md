...
- [rdx/handlers/event.py:8-10](file://rdx/handlers/event.py#L8-L10)
- [rdx/replay_observation.py:40-147](file://rdx/replay_observation.py#L40-L147)
- [rdx/core/session_manager.py:260-273](file://rdx/core/session_manager.py#L260-L273)
...
图表来源
- [rdx/core/event_graph.py:152-191](file://rdx/core/event_graph.py#L152-L191)
- [rdx/core/event_graph.py:195-248](file://rdx/core/event_graph.py#L195-L248)
- [rdx/core/event_graph.py:252-309](file://rdx/core/event_graph.py#L252-L309)
- [rdx/models.py:163-181](file://rdx/models.py#L163-L181)
...
- [rdx/core/session_manager.py:175-251](file://rdx/core/session_manager.py#L175-L251)
- [rdx/core/session_manager.py:260-273](file://rdx/core/session_manager.py#L260-L273)
- [rdx/core/session_manager.py:509-515](file://rdx/core/session_manager.py#L509-L515)
...
- [rdx/models.py:463-483](file://rdx/models.py#L463-L483)
...
章节来源
- [rdx/replay_observation.py:55-90](file://rdx/replay_observation.py#L55-L90)
...
- 示例路径参考：
  - 处理器转发：[rdx/handlers/event.py:8-10](file://rdx/handlers/event.py#L8-L10)
  - 事件列表获取：[rdx/replay_observation.py:52-53](file://rdx/replay_observation.py#L52-L53)

章节来源
- [rdx/handlers/event.py:8-10](file://rdx/handlers/event.py#L8-L10)
- [rdx/replay_observation.py:52-53](file://rdx/replay_observation.py#L52-L53)

### 捕获特定类型或属性事件
- 类型过滤：使用事件图服务的 get_draw_events 筛选 draw/dispatch 事件
- 属性过滤：结合 EventFlags 与 output_targets 进行更细粒度筛选
- 示例路径参考：
  - 绘制事件收集：[rdx/core/event_graph.py:195-202](file://rdx/core/event_graph.py#L195-L202)
  - 标志位映射：[rdx/core/event_graph.py:66-96](file://rdx/core/event_graph.py#L66-L96)

章节来源
- [rdx/core/event_graph.py:195-202](file://rdx/core/event_graph.py#L195-L202)
- [rdx/core/event_graph.py:66-96](file://rdx/core/event_graph.py#L66-L96)
...
- 示例路径参考：
  - 上下文与进度：[rdx/server.py:79-107](file://rdx/server.py#L79-L107)
  - 输出目标查询：[rdx/replay_observation.py:108-110](file://rdx/replay_observation.py#L108-L110)

章节来源
- [rdx/server.py:79-107](file://rdx/server.py#L79-L107)
- [rdx/replay_observation.py:108-110](file://rdx/replay_observation.py#L108-L110)
...
- 示例路径参考：
  - 事件范围计算：[rdx/core/event_graph.py:204-216](file://rdx/core/event_graph.py#L204-L216)
  - 目标选择逻辑：[rdx/replay_observation.py:61-90](file://rdx/replay_observation.py#L61-L90)

章节来源
- [rdx/core/event_graph.py:204-216](file://rdx/core/event_graph.py#L204-L216)
- [rdx/replay_observation.py:61-90](file://rdx/replay_observation.py#L61-L90)
...
- 示例路径参考：
  - 绘制事件收集：[rdx/core/event_graph.py:195-202](file://rdx/core/event_graph.py#L195-L202)
  - 性能采样：[rdx/core/perf_service.py:314-487](file://rdx/core/perf_service.py#L314-L487)
...
- 常见错误码：
  ...
  - export_failure
- 示例路径参考：
  - 日志记录：[rdx/server.py:90-141](file://rdx/server.py#L90-L141)
  - 错误处理：[rdx/replay_observation.py:55-90](file://rdx/replay_observation.py#L55-L90)

章节来源
- [rdx/server.py:90-141](file://rdx/server.py#L90-L141)
- [rdx/replay_observation.py:55-90](file://rdx/replay_observation.py#L55-L90)