...
```mermaid
graph TB
CLI["CLI<br/>rdx diff/assert"] --> SR["Server Runtime<br/>工具分发"]
...
- [operation_definitions.py:867-874](file://rdx/operation_definitions.py#L867-L874)
...
- [pipeline_service.py:597-702](file://rdx/core/pipeline_service.py#L597-L702)
- [verifiers.py:591-679](file://rdx/core/verifiers.py#L591-L679)
- [assert_service.py:16-35](file://rdx/core/assert_service.py#L16-L35)
- [operation_definitions.py:867-874](file://rdx/operation_definitions.py#L867-L874)
- [operation_definitions.py:1461-1483](file://rdx/operation_definitions.py#L1461-L1483)
- [server_runtime.py:1-200](file://rdx/server_runtime.py#L1-L200)
- [cli.py:1583-1604](file://rdx/cli.py#L1583-L1604)
...
U->>C : rdx diff pipeline --event-a A --event-b B
...
图表来源
- [cli.py:1583-1604](file://rdx/cli.py#L1583-L1604)
- [diff_service.py:11-29](file://rdx/core/diff_service.py#L11-L29)
- [operation_definitions.py:867-874](file://rdx/operation_definitions.py#L867-L874)
- [pipeline_service.py:597-702](file://rdx/core/pipeline_service.py#L597-L702)
...
- [operation_definitions.py:867-874](file://rdx/operation_definitions.py#L867-L874)
- [pipeline_service.py:318-373](file://rdx/core/pipeline_service.py#L318-L373)
- [verifiers.py:641-679](file://rdx/core/verifiers.py#L641-L679)
...
- CLI 集成：rdx diff pipeline/image 直接输出 JSON；rdx assert pipeline/image 以 0/1/2 退出码表达通过/失败/错误
...
### 实际应用场景
- 回归测试：在 CI 中运行 rdx assert pipeline，设置 max_changes=0 确保无意外状态变更；或允许少量已知变更
...
图表来源
- [diff_service.py:11-51](file://rdx/core/diff_service.py#L11-L51)
- [pipeline_service.py:56-82](file://rdx/core/pipeline_service.py#L56-L82)
...
- [pipeline_service.py:193-250](file://rdx/core/pipeline_service.py#L193-L250)
- [assert_service.py:37-78](file://rdx/core/assert_service.py#L37-L78)
...
## 附录：使用示例与最佳实践
- 比较两个事件管线状态
  - 使用 CLI：rdx diff pipeline --event-a A --event-b B
...
- 断言与阈值
  - rdx assert pipeline --max-changes N：允许最多 N 处变更
  - rdx assert image --mse-max/--psnr-min/--max-abs-max：图像指标阈值
- 最佳实践
