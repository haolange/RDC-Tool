...
from rdc_tool.core.renderdoc_status import status_code_name, status_code_raw, status_text
    ...
    async def save_texture_file(
        ...
        *,
        ...
        if output_path:
            ...
            fd, temp_path = tempfile.mkstemp(prefix="rdc_tool_tex_", suffix=suffix)
            os.close(fd)
