...
logger = logging.getLogger("rdc_tool.core.verifiers")
...
class VerifyContext:
    ...
    capture_id: str
    event_id: int
    session_manager: Any          # rdc_tool.core.session.SessionManager
    artifact_store: Any           # rdc_tool.core.artifacts.ArtifactStore
    render_service: Any           # rdc_tool.core.render.RenderService
...
class NaNInfVerifier(BaseVerifier):
    ...
    async def verify(self, context: VerifyContext) -> VerifyResult:
        ...
        try:
            from rdc_tool.utils import image_utils
        except ImportError:
