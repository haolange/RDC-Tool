...
转换为可序列化的 :class:`~rdc_tool.models.EventNode` 树，并提供查询、展开、
...
from rdc_tool.models import EventFlags, EventNode
...
class EventGraphService:
    ...
    def build_event_tree(
        ...
        session_manager:
            ...
            :class:`~rdc_tool.core.session_manager.SessionManager` 实例。
